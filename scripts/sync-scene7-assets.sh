#!/usr/bin/env bash
# Copy store_family.png goldens for Remotion Scene 7 (phone + tablet).
# Run: cd learn.ai.video && npm run sync:scene7
...
DEST="$VIDEO_ROOT/public/assets/scene7"
